...
function Intro() {
  return (
    <>
    {/* Intro */}
      <div id="about" className="container mx-auto px-20 py-10 h-[50vh] flex flex-col justify-center sm:px-5 h-[80vh] md:px-7">
        <div className="grid grid-cols-3 gap-10 sm:grid-cols-1 gap-5">
          <section>
            <Fade bottom>
              <h3 className='font-cinzel text-[30px] sm:text-[20px] md:text-[24px]'>Welcome to Archstone</h3>
            </Fade>
          </section>
          <section className="text-black text-sm font-montserrat sm:text-xs md:text-xs">
